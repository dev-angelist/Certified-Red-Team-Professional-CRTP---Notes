...
* [📝 Certified Red Team Professional (CRTP) - Notes](README.md)
  ...
  * [1️⃣ 1 - Active Directory and Kerberos](readme/system-security-1/README.md)
    * [1.1 - Active Directory (AD)](readme/system-security-1/1.1-active-directory-ad.md)
    * [1.2 - Physical Components of Active Directory](readme/system-security-1/1.2-physical-components-of-active-directory.md)
    * [1.3 - Logical Components of Active Directory](readme/system-security-1/1.3-logical-components-of-active-directory.md)
